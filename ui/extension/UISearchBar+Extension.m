...
@def_prop_custom_block(void (^)(UISearchBar *, NSInteger), completionSelectedScopeButtonIndexDidChangeBlock, setCompletionSelectedScopeButtonIndexDidChangeBlock, copy, ^{}, ^{[self setDelegateIfNoDelegateSet];})
